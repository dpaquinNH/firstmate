...
FM_CLASSIFY_PAUSED_VERB=paused     # leading status verb for a declared wait expected to clear on its own, an external dependency or the worker's own long job; excluded from FM_CAPTAIN_RE and distinct from blocked
